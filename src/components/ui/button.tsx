...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:bg-from-neutral-100 disabled:bg-to-neutral-100 disabled:text-muted-foreground border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          "bg-white text-blue hover:bg-neutral-100",
